...
const FooterSection = () => {
  ...
  return (
    <footer ref={containerRef} id="footer" className="min-h-screen flex items-center py-10 sm:py-14 px-6 sm:px-8 pb-24 sm:pb-28 perspective-[1000px] transform-style-preserve-3d">
      <motion.div 
