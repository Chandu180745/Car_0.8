...
const DatasetExplorer = () => {
  ...
  return (
    <section id="dataset" className="py-12 sm:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="section-border p-4 sm:p-6 md:p-8 glass-card border-cyan-500/15">
          ...
          {expanded && (
            <div className="animate-reveal-up">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {pageData.map((car) => (
                  <div key={car.id} className="glass-card p-3 hover:border-cyan-500/20 transition-all duration-300 group border-white/5">
