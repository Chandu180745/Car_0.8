...
import { Search, ChevronLeft, ChevronRight, Database, SlidersHorizontal, X } from "lucide-react";
...
const classColor: Record<string, string> = {
  ...
  Good: "bg-result-good/15 text-result-good border-result-good/30",
      ...
      <div className="max-w-6xl mx-auto">
        <ScrollReveal className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/20 bg-primary/5 mb-6">
            ...
            <span className="text-xs text-primary font-medium">{cars.length} Cars</span>
          </div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{car.year} · ₹{car.buyingPrice}L</p>
                  </div>
